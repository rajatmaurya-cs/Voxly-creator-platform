  ...
  const plansList = [
    {
      ...
      popular: false,
      features: [
        { text: "1 AI Generation limit", icon: Zap },
        { text: "2 AI Summariser limit", icon: MessageSquare },
    ...
    },
    {
      ...
      popular: true,
      features: [
        { text: "10 AI Generation limit", icon: Zap },
        { text: "10 AI Summariser limit", icon: MessageSquare },
    ...
    },
    {
      ...
      popular: false,
      features: [
        { text: "40 AI Generation limit", icon: Zap },
        { text: "40 AI Summariser limit", icon: MessageSquare },
        ...
        <div className="max-w-7xl w-full mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
            {plansList.map((plan) => {
              ...
              const isCurrentPlan = user && (user.plan?.name ? (user.plan.name.toLowerCase() === plan.id.toLowerCase()) : (plan.id === "free"));
              return (
                <div
                  key={plan.id}
