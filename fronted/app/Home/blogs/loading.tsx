      ...
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 lg:px-8">
        ...
        <div className="mb-10 flex flex-col gap-6">
          ...
          <div className="relative mx-auto w-full max-w-lg">
            <div className="w-full h-14 rounded-2xl border border-white/10 bg-white/5 animate-pulse" />
          </div>
        </div>
        ...
        <div className="mb-10 flex flex-wrap justify-center gap-3 animate-pulse">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className="rounded-full border border-white/10 bg-white/[0.03] px-5 py-2.5 h-10 w-24"
            />
          ))}
        </div>
