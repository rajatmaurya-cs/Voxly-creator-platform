          ...
          <div className="flex items-center justify-between px-1 py-2 mb-4">
            <Link href="/" className="flex items-center gap-3 transition-opacity hover:opacity-90 group">
              ...
              <div className="flex flex-col justify-center">
                <span
                  className="text-lg sm:text-xl font-bold tracking-widest uppercase bg-gradient-to-r from-indigo-600 via-indigo-900 to-violet-750 bg-clip-text text-transparent"
